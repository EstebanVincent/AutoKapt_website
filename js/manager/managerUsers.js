$(document).ready(function ($) {
    ...
    function create_html_table(tbl_data) {
        ...
        if (number_View == 0) {
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: function () {
                        window.location.replace(start + "/AutoKapt/View/Manager/managerUsers.php?page=1&entries=20");
                    },
                },
            });
    ...
    function create_form(form_data) {
        //--->create form > start
        var form = "";
        form += '<form action="/AutoKapt/includes/Manager/search.inc.php" method="POST">';
    ...
    var ajax_url = "/AutoKapt/includes/ajax/managerUsers.ajax.php";
