...
function showActivity($conn, $userId){
    ...
    for ($i = 0; $i < count($array); $i++) {
        switch ($array[$i]['testType']) {
            case 0:
                $array[$i]['testType'] = '<a href="/AutoKapt/View/User/play/p.stress.php"><i class="fas fa-brain"></i></a> Stress';
                break;
            case 1:
                $array[$i]['testType'] = '<a href="/AutoKapt/View/User/play/p.reflex.php"><i class="fas fa-music"></i></a> '. $lang["dashboard-reflex"];
                break;
            case 2:
                $array[$i]['testType'] = '<a href="/AutoKapt/View/User/play/p.reflex.php"><i class="fas fa-music"></i></a> '. $lang["dashboard-memory"];
                break;
            case 3:
                $array[$i]['testType'] = '<a href="/AutoKapt/View/User/play/p.reflex.php"><i class="fas fa-music"></i></a> '. $lang["dashboard-hearing"];
                break;
        }
    }
...
function getMemoryTotal($conn, $sessionId){
    $sql = "SELECT memoryRythm AS x FROM memory;";
    $stmt = mysqli_stmt_init($conn);
